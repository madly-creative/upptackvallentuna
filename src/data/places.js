...
const PLACES_RAW = [
    ...
    {name:"Orkesta Granby Gård",cat:"Gård & lantbruk",type:"gard",lat:59.5946698,lng:18.0976369,color:"#3d4f3a",oh:0,ch:0,web:true,url:"https://granbygard.com/",blurb:"Modernt livsmedelsproducerande lantbruk mitt i vikingalandskapet — spannmål, Charolais-kött och odling. På gården ligger besöksverksamheten Hökeriet (eget bolag) med butik och servering.",short:"Livsmedelsproducerande lantbruk mitt i vikingalandskapet.",img:"/assets/upplev/orkesta-granby-gard/cover-garden.webp"},
    {name:"Hökeriet",cat:"Butik & servering",type:"fika",types:["fika","gard"],lat:59.59455,lng:18.09785,color:"#a85a3a",oh:12,ch:16,web:true,url:"https://hokeriet.se/",phone:"+46 76 945 90 10",blurb:"Besöksföretag på Orkesta Granby Gård — butik, servering, turistinformation, guidade turer och event. Eget bolag som levererar Granby som plats för besökare.",short:"Butik, servering, guidade turer och event på Granby.",img:"/assets/upplev/hokeriet/cover.webp"},
