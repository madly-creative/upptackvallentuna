...
{name:"Lejonkulan Presenter & Inredning",cat:"Present & Inredning",type:"butik",lat:59.5339568,lng:18.0788346,color:"#a85a3a",oh:10,ch:18,web:true,url:"https://vallentunacentrum.se/butik/lejonkulan-trend-interior/",phone:"+46 8 511 807 30",blurb:"Lejonkulan Foto & Interiör vid Tuna Torg — inredning, presenter, kläder och smycken, plus hjälp med fotoframkallning, ramar och album. Personligt och omsorgsfullt mitt i centrum.",short:"Presenter, inredning och fotoframkallning vid torget.",img:"/assets/upplev/lejonkulan-presenter-och-inredning/cover.webp"},
    ...
    {name:"Rookie Café & Restaurang",cat:"Lunch & Café",type:"fika",lat:59.534303,lng:18.0945687,color:"#a85a3a",oh:11,ch:14,web:true,url:"https://www.facebook.com/rookiecaferestaurang/",phone:"+46 8 30 06 80",blurb:"Oväntat god lunch i Vallentuna ishall — lagat från grunden, prisvärt, med sallad, måltidsdryck och kaffe med kaka. En dold pärla för den som råkar vara i trakten, och en varm plats att se matchen från.",short:"Prisvärd husmanslunch, lagad från grunden.",img:"/assets/upplev/rookie-cafe-och-restaurang/cover.webp"},
    ...
    {name:"Gustavs udde",cat:"Bad & Natur",type:"natur",lat:59.5197400,lng:18.0649727,color:"#2f3d2e",oh:0,ch:24,web:true,url:"https://www.vallentuna.se/fritid-och-kultur/friluftsliv-och-natur/badplatser-och-sjoar/",blurb:"Kommunal badplats vid Bergsjön / Bällsta — brygga, gräsytor och stillare bad än Kvarnbadets bassänger. Packa handduk och ta en paus vid sjön.",short:"Kommunalt bad vid Bergsjön i Bällsta.",img:"/assets/upplev/gustavs-udde/cover.webp"},
